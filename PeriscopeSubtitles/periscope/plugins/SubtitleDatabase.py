...
class SubtitleDB(object):
	...
	def getFileName(self, filepath):
		...
		if filename.endswith('.avi') or filename.endswith('.wmv') or filename.endswith('.mov') or filename.endswith('.mp4') or filename.endswith('.mpeg') or filename.endswith('.mpg'):
